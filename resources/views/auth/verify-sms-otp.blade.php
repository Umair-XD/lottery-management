                    ...
                    <div class="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                        <svg class="w-5 h-5 text-[#223871]" viewBox="0 0 24 24" fill="none"
                            ...
                            <circle cx="3" cy="3" r="3" transform="matrix(-1 0 0 1 22 2)"
                                stroke="#223871" stroke-width="1.5" />
                            <path
                                d="M14 2.2C13.354 2.069 12.685 2 12 2C10.179 2 8.471 2.487 7 3.338M21.8 10C21.93 10.646 22 11.315 22 12C22 17.523 17.523 22 12 22C10.4 22 8.888 21.624 7.548 20.957L6.399 20.823L4.173 21.419L3.178 17.601C3.28 17.216 3.221 16.809 3.043 16.452C2.376 15.112 2 13.6 2 12C2 10.179 2.487 8.471 3.338 7"
