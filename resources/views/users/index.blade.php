<x-app-layout>
    ...
    {{-- <section class="download py-24">
        <div class="flex flex-col items-center gap-6">
            <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-[45px] font-medium text-center pt-12">DOWNLOAD, PLAY,
                WIN</h2>
            <div class="flex flex-col sm:flex-row justify-center items-center gap-10">
                <!-- Google Play Button -->
                <a href="https://play.google.com" target="_blank"
                    class="flex items-center justify-center h-20 sm:h-24 bg-[#060606] text-white px-8 sm:px-12 rounded-2xl">
