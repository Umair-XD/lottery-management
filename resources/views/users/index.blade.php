<x-app-layout>
    ...
    <section id="winning-section" class="px-20">
        <div class="text-center">
            <h2 class="text-[45px] pt-12 font-medium text-center">Winning Members</h2>
            <!-- Use 4 columns on md and above -->
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-10 mt-16">
                ...
                <div
                    ...
                    <h3 class="text-[32px] font-normal uppercase">Grand Prize Winner</h3>
                ...
                <div
                    ...
                    <h3 class="text-[32px] font-normal uppercase">Meet Our Lucky Winners</h3>
                ...
                <div
                    class="bg-[#21366F] gap-9 text-white shadow-lg rounded-[30px] p-8 flex flex-col items-center md:col-span-1">
                    <h3 class="text-[32px] font-normal uppercase">Total Winning & Counting</h3>
    ...
    <section class="download py-24">
        <div class="flex flex-col items-center gap-6">
            <h2 class="text-[45px] pt-12 font-medium">DOWNLOAD, PLAY, WIN</h2>
            <div class="flex flex-col sm:flex-row justify-center items-center gap-10">
                <!-- Google Play Button -->
                <a href="https://play.google.com" target="_blank"
                    class="flex items-center justify-center h-24 bg-[#060606] text-white px-12 py-4 rounded-2xl shadow hover:shadow-lg transition">
                    ...
                    <p class="flex flex-col">
                        <span class="text-slate-300 font-light text-lg">Available App on</span>
                        <span class="font-normal text-2xl">Google Play</span>
                    </p>
                </a>
                <!-- App Store Button -->
                <a href="https://www.apple.com/app-store/" target="_blank"
                    class="flex items-center bg-[#060606] h-24 text-white px-12 py-4 rounded-2xl shadow hover:shadow-lg transition">
                    ...
                    <p class="flex flex-col">
                        <span class="text-slate-300 font-light text-lg">Download on</span>
                        <span class="font-normal text-2xl">App Store</span>
                    </p>
                </a>
            </div>
        </div>
