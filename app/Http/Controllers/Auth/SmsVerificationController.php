...
class SmsVerificationController extends Controller
{
    ...
    // 1️⃣ Show “Send/Resend OTP” form
    public function showRequestForm()
    {
        return view('auth.request-sms-otp');
    }

    // 2️⃣ Handle the “Send OTP” action
    public function sendOtp(Request $request)
    {
        ...
        return redirect()->route('sms.verify.form')->with('status', "OTP sent to {$e164}");
    }

    // 3️⃣ Show “Enter OTP” form
    public function showVerifyForm()
    {
        return view('auth.verify-sms-otp');
    }

    // 4️⃣ Verify the submitted OTP
